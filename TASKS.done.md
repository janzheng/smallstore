...
- [x] [done 2026-04-29, no commit — operational] **Deleted retired `com.smallstore.mailroom-sync.plist.disabled-2026-04-29`** — verified the post-migration wiring stayed stable (tigerflare server's universal `/mailroom/` space-sync flowing cleanly into `tigerflare/data/cloud/mailroom/` on its 30-min cron tick). The smallstore-specific plist's function had been absorbed; the `.disabled-2026-04-29` file was kept as a safety net. Now removed outright. #ops #migration-cleanup
